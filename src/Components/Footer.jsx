...
const Footer = () => {
  ...
  return (
    ...
    <div>
    <h5>Email</h5>
        <a href="mailto:lucifer123saurav@gmail.com">lucifer123saurav@gmail.com</a>
        <a href="mailto:franchise@gmail.com">franchise@gmail.com</a>
      
    </div>
    <div>
    <h5>Phone</h5>
        <a href="tel:+912723369">+912713369</a>
      
    </div>
    <p>
    © COPYRIGHT 2023 B.TECH CHAIWALA. MADE BY
    </p>
    </footer>
